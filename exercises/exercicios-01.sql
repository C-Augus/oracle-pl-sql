...
CREATE TABLE tb_funcao(
    ...
    ds_funcao VARCHAR2(36) CONSTRAINT nn_ds_funcao NOT NULL, 
...
ADD (
    ...
    CONSTRAINT fk_emp_depto FOREIGN KEY(id_departamento) REFERENCES tb_departamento(id_departamento),
    CONSTRAINT fk_emp_funcao FOREIGN KEY (id_funcao) REFERENCES tb_funcao(id_funcao),
    CONSTRAINT fk_id_gerente FOREIGN KEY (id_gerente) REFERENCES tb_empregado(id_empregado)
);
...
CREATE TABLE tb_historico_funcao(
    ...
    CONSTRAINT ok_hist_data_intervalo CHECK (data_termino > data_inicio)
);
...
ADD (
    CONSTRAINT pk_hist_emp_id_emp PRIMARY KEY(id_empregado, data_inicio),
    CONSTRAINT fk_hist_funcao_funcao FOREIGN KEY(id_funcao) REFERENCES tb_funcao(id_funcao),
    CONSTRAINT fk_hist_funcao_emp FOREIGN KEY(id_empregado) REFERENCES tb_empregado(id_empregado),
